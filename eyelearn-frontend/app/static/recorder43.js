...
//            button.addEventListener("click", postData());
    ...
    //var url = URL.createObjectURL(this.audio);
...
//    upload.addEventListener("click", function(event){
          ...
          var endpoint = pathname[pathname.length-1];
          var speechEndpoint;
          if(endpoint === "speech") {

            speechEndpoint = "/sendSpeech";
          }

          else{
             speechEndpoint = "/getSpeechTranslation";
...
//    };
	...
	function visualize(stream) {
		...
		function draw() {
			...
			canvasCtx.strokeStyle = config.visualizer.forecolor || '#00a5ff';
